(function($) {
    ...
    $(function() {
        ...
        if(typeof(content_expiry_static_url_prefix) != 'undefined'){
          burger_menu_icon = `${content_expiry_static_url_prefix}svg/menu.svg`;
        } else {
          burger_menu_icon = '/static/djangocms_content_expiry/svg/menu.svg';
          console.warn('"content_expiry_static_url_prefix" not defined! No value has been provided for static_url, '
                      + 'defaulting to "/static/djangocms_content_expiry/svg/" for icon location.');
        }
        ...
        let createBurgerMenu = function createBurgerMenu(row) {
            ...
            anchor.setAttribute('class', 'btn cms-content-expiry-action-btn closed');
            ...
            $(actions[0]).children('.cms-content-expiry-action-btn').each(function (index, item) {
              ...
              let subSpan = $(item).children('span')[0];
              li_anchor.appendChild($(subSpan).children('img')[0]);
          ...
          let closeBurgerMenu = function closeBurgerMenu() {
            ...
            $('.cms-content-expiry-action-btn').removeClass('open');
            $('.cms-content-expiry-action-btn').addClass('closed');
          };
